...
@ccclass
export default class End1_Ctrl extends UIBase {
    layout: cc.Node;
    labPrice: cc.Label;
    timeCur: number;
    labTime: cc.Label;
    ...
    public setData(data: RewardResponse[]) {
        let pre = ResMgr.Instance.getAsset(AbNames.Prefabs, UICfg.EndItem, cc.Prefab) as cc.Prefab;
        if (data) {
