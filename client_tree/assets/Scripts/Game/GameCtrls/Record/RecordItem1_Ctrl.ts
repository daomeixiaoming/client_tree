...
@ccclass
export default class RecordItem1_Ctrl extends UIBase {
    labTime: cc.Label;
    labScore: cc.Label;
    content: cc.Node;
    onLoad() {
        console.log("=============RecordItem1_Ctrl.onLoad===================");
        super.onLoad();
        this.initUI();
    ...
    private initUI() {
        ...
        this.content = this.view["scrollView/view/content"] as cc.Node;
    }
    ...
    private setData(data: LuckyEggRecordsResponse) {
        console.log("=============RecordItem1_Ctrl.setData===================");
